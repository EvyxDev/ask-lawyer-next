...
import { getCompanies } from "@/lib/apis/companies";

const LawsFirm = () => {
  const t = useTranslations("LawCompanies");
  ...
  const {
    ...
    queryKey: ["Laws-firm", currentPage, order],
    queryFn: () => getCompanies(order, currentPage, lawyersPerPage, order),
  });
