...
const QuestionsAndAnswers = () => {
  ...
  const {
    ...
    queryKey: ["blog-questions_and_answers", currentPage, order],
    queryFn: () => getBlogs(4, currentPage, blogsPerPage, order),
  });
  ...
  return (
    <section>
      <Banner titleKey="legalInformation.questions_and_answers" />
