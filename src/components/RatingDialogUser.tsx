...
import { rateUsersRequest } from "@/lib/apis/rating";
import { useForm, SubmitHandler } from "react-hook-form";

export default function RatingDialogUser({ requestId }: { requestId: number }) {
...
const queryClient = useQueryClient();
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: ({ rating, message }: RateFormData) =>
      rateUsersRequest(String(requestId), rating, message),
      onSuccess: () => {
